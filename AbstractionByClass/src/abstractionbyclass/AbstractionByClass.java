/*
 It is the capability of data hiding, so that only user can interact with the 
only system to perform task, but user cant go inside the code. For example, when 
